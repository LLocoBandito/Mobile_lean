      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardContainer}>
          ...
          {loading ? (
            ...
            <>
              <InfoRow label="Nama Lengkap" value={profile?.name || "-"} icon="person-outline" />
              <View style={styles.divider} />
              <InfoRow label="Alamat" value={profile?.address || "-"} icon="location-outline" />
              <View style={styles.divider} />
              <InfoRow label="Tipe Motor" value={profile?.bikeType || "-"} icon="bicycle-outline" />
              <View style={styles.divider} />
              <InfoRow label="Gol. Darah" value={profile?.bloodType || "-"} icon="water-outline" />
              <View style={styles.divider} />
              <InfoRow
                label="No. Darurat"
...
const styles = StyleSheet.create({
  ...
  welcomeText: { color: "#F8FAFC", fontSize: 24, fontWeight: "700", marginBottom: 4 },
  ...
  divider: { height: 1, backgroundColor: "#334155", marginVertical: 12, marginLeft: 48 },
